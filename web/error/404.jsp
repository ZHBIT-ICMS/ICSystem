...
.img404 {PADDING-RIGHT: 0px; PADDING-LEFT: 0px; BACKGROUND: url() no-repeat left top; FLOAT: left; PADDING-BOTTOM: 0px; MARGIN: 0px; WIDTH: 80px; PADDING-TOP: 0px; POSITION: relative; HEIGHT: 90px}
...
<STRONG>点击以下链接继续浏览电子签章系统上的其它内容</STRONG> 
<DIV class=show14>
<UL>
  <LI><A title=返回电子签章首页 href="#">返回电子签章系统首页</A> 
  <LI><A title=返回上一个页面 href="javascript:history.back(-1)">返回上一页</A></LI>
</UL></DIV>
要不，我们去<A href="#" target=_blank>..........</A>看看吧~~ </DIV>
<SPAN 
