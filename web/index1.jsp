		...
		<div class="col-md-4 col1 gallery-grid">
			<a href="images/g1.jpg" class="b-link-stripe b-animate-go  thickbox">
					...
					<figure class="effect-bubba">
						...
						<figcaption>
							<h4 class="gal">Education NEWS</h4>
...
<div class="left-contact">
		...
		<ul>
			...
			<li><i class="fa fa-map-marker" aria-hidden="true"></i>34, North Polytechnic, No. 6, Jin Feng Road, Tangjia Bay, Xiangzhou District, Zhuhai, Guangdong Province, zip code: 519088</li>
		</ul>
