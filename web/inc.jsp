...
<!-- easyui插件库 -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/easyUI/jquery-easyui-portal/portal.css" type="text/css"></link>
<script type="text/javascript" src="${pageContext.request.contextPath}/easyUI/jquery-easyui-portal/jquery.portal.js" charset="utf-8"></script>
<!-- 自定义库 -->
